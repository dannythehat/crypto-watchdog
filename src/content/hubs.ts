...
export const hubs: Hub[] = [
  ...
  },
  {
    ...
    groups: [
      ...
      { title: "Smart-contract wallets", subtitle: "Account-abstraction & multi-sig for advanced security.", slugs: ["safe-gnosis", "argent-wallet"] },
  ...
  },
  {
    ...
    eyebrow: "AI Trading Bots",
    title: "AI Crypto Trading Bots 2026: Real Tools vs AI-Washed Scams",
    metaTitle: "AI Crypto Trading Bots 2026: Best vs Scams",
    metaDescription:
      "AI trading bots claim to adapt to the market for you. A few are genuine; most use 'AI' to dress up a high-yield scam. See which AI crypto trading bots we rate — and which to avoid.",
    keyword: "ai crypto trading bots",
    mood: "scan",
    accent: "#4F8BFF",
    heroPrompt:
    ...
    relatedPosts: [
      "aurum-neyro-bot-review-is-aurum-a-scam",
      "aurum-ex-bot-how-it-works-step-by-step",
      "aurum-neyro-quantum-alpha-beta-launch",
      "self-custody-ai-crypto-trading-aurum-neyro",
      "aurum-foundation-hacken-audit-50m-round-trust-signals-2026",
      "neyro-aurum-full-presentation-non-custodial-ai-trading-agents-2026",
      "what-is-ai-finance-crypto",
      "non-custodial-ai-trading-bots-explained",
      "non-custodial-smart-contract-trading-explained",
      "how-smart-contracts-work-crypto-trading",
      "ai-trading-bots-and-agents-2026-honest-guide",
      "copy-ai-trading-explained-2026",
      "crypto-trading-bot-audit-step-by-step-guide",
      "ai-trading-bots-your-guide-to-separating-genuine-tools-from-get-rich-quick-scams-2026-05-25",
      "how-to-spot-ai-washing-crypto",
      "crypto-trading-bot-risks-safer-trading",
      "are-telegram-trading-bots-safe-a-crypto-watchdog-investigation-2026-05-09",
      "telegram-trading-bots-convenience-at-what-cost-2026-04-23",
    ],
    faq: [
      { q: "Can an AI bot really trade profitably for me?", a: "Some genuinely use models and risk controls that help a disciplined trader. But no honest platform promises fixed daily profit — markets don't work that way. A guarantee is the tell." },
      { q: "What is 'AI-washing'?", a: "Marketing a project as AI-powered to look sophisticated, while the business underneath is just a high-yield scheme paying old depositors with new money. The 'AI' is decoration." },
      { q: "How do I tell a real AI bot from a scam?", a: "Real ones explain the strategy, let you keep custody, and show verifiable results. Scams hide the strategy, hold your funds, and lean on testimonials and guarantees." },
    ],
  },
  {
    slug: "trading-bots",
    eyebrow: "Trading Bots",
    title: "Crypto Trading Bots 2026: Grid, DCA & Automation, Rated",
    metaTitle: "Best Crypto Trading Bots 2026: Safe vs Scam",
    metaDescription:
      "Rule-based crypto trading bots automate a strategy you set — grid, DCA, rebalancing. See which trading bots we rate, which need caution, and the red flags that signal a scam.",
    keyword: "best crypto trading bots",
    mood: "caution",
    accent: "#F5A524",
    heroPrompt:
    ...
    heroSeed: 36,
    heroImage: "/trading-bots/hero.png",
    intro:
      "A rule-based trading bot does exactly what you tell it — grid, DCA, rebalancing — and nothing more. Good ones are transparent tools you stay in control of, connecting via trade-only API keys on your own exchange. Bad ones ask you to **deposit into their account and promise profit** — the classic setup for disappearing with your money.\n\nHere's how the main bots stack up, plus the [hidden costs of leverage](/blog/the-hidden-costs-of-crypto-leverage-for-beginners-more-than-just-margin-calls-2026-04-18) automation can quietly amplify.",
    trusted: ["pionex"],
    caution: ["3commas", "cryptohopper"],
    ...
    faq: [
      ...
      { q: "Are API-key bots safer?", a: "Safer, yes — especially with withdrawal permissions disabled on the key, so the bot can trade but never move funds out. Not risk-free, but you keep custody." },
    ],
  },
  {

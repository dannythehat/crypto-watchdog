...
export const casinos: Casino[] = [
  ...
  { slug: "bitstarz", name: "BitStarz", domain: "bitstarz.com", kind: "Casino", rating: "green", trustScore: 80, established: "2014", license: "Curaçao", coins: "Crypto + fiat", highlight: "Award-winning hybrid casino famous for fast payouts.", offer: "Welcome package up to 5 BTC + 180 free spins", logo: "/brands/bitstarz.png", banner: "/brands/bitstarz-banner.png", accent: "#2bb3ff" },

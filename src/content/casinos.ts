...
export const casinos: Casino[] = [
  { slug: "cloudbet", name: "Cloudbet", domain: "cloudbet.com", kind: "Casino & Sportsbook", rating: "green", trustScore: 84, established: "2013", license: "Curaçao", coins: "30+ coins", highlight: "12-year track record, high limits, Zero-Margin odds.", offer: "100% deposit match up to 5 BTC", special: { text: "US Open: new accounts get a £100 free bet", until: "2026-06-21" }, affiliateUrl: "https://affiliates.cloudbet.com/referral?af_token=5c19df15d41d58328206705e365c8df8", logo: "/brands/cloudbet.jpg", accent: "#f5a623", featured: true },
  ...
  { slug: "bitstarz", name: "BitStarz", domain: "bitstarz.com", kind: "Casino", rating: "green", trustScore: 80, established: "2014", license: "Curaçao", coins: "Crypto + fiat", highlight: "Long-running hybrid casino with fast payouts.", offer: "Welcome package up to 5 BTC + 180 free spins", logo: "/brands/bitstarz.png", accent: "#2bb3ff" },
  { slug: "sportsbet-io", name: "Sportsbet.io", domain: "sportsbet.io", kind: "Sportsbook", rating: "green", trustScore: 78, established: "2016", license: "Curaçao", coins: "Major coins", highlight: "Sportsbook-first, deep live markets, established group.", offer: "Bet £10, get a £10 free bet", special: { text: "US Open special: £100 in free bets for new accounts", until: "2026-06-21" }, logo: "/brands/sportsbet-io.png", accent: "#ffd400" },

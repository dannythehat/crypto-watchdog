...
rating: "orange"
trust_score: 76
summary: "An intent-based cross-chain bridge known for the fastest fills and lowest fees among major bridges. Backed by UMA's optimistic oracle."
verdict: "Currently one of the safer and more efficient bridges. Uses a relayer model where third parties front the funds, then get repaid — meaning users get near-instant transfers. Still: bridges are the highest-risk surface in crypto. Never bridge more than you can afford to lose."
category_id: "b7ed3673-0f02-4884-b93e-83881a5a8b78"
website_url: "https://across.to"
logo_url: "https://across.to/favicon.ico"
social_image_url: null
pros: ["Fastest fills among major bridges (often under a minute)","Competitive fees thanks to relayer competition","Backed by UMA's battle-tested optimistic oracle","Open-source contracts, multiple audits","No locked liquidity per chain — capital efficient"]
cons: ["Bridges remain the most exploited category in crypto","Relies on relayers being economically rational","Smaller chain coverage than LayerZero/Stargate"]
fees_info: null
...
Currently one of the safer and more efficient bridges. Uses a relayer model where third parties front the funds, then get repaid — meaning users get near-instant transfers. Still: bridges are the highest-risk surface in crypto. Never bridge more than you can afford to lose.

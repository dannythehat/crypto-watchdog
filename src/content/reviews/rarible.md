...
rating: "orange"
trust_score: 70
summary: "A multi-chain NFT marketplace with its own RARI governance token. Supports Ethereum, Polygon, Tezos, Immutable, and more."
...
A reasonable second-tier NFT marketplace — multi-chain support is genuinely useful, and royalties are enforced. But volume sits well behind OpenSea, Blur, and Magic Eden. Use it if you need a chain they don't serve, otherwise the bigger marketplaces have deeper liquidity.

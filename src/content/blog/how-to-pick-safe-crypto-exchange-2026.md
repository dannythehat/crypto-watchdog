...
|---|---|---|
| **Custody & solvency** | Proof-of-reserves verified by independent auditor + clear hot/cold wallet split | "Trust us" + vague terms about commingled funds |
| **Regulation** | Licensed in tier-1 jurisdiction (US, EU MiCA, UK FCA, Singapore MAS) for the activity it offers | Offshore-only, or licences that don''t cover the actual product |
| **Withdrawal performance** | Consistent withdrawals at retail and large size, including in market stress | Periodic "system upgrades" that conveniently delay outflows |
...
|---|---|---|---|---|---|
| **[Coinbase](/reviews/coinbase)** | US users wanting maximum regulatory comfort | Public US-listed company, NY BitLicense, MiCA | Audited Big-4 | Excellent — never paused | 🟢 Green |
| **[Kraken](/reviews/kraken)** | Long-term holders, security-conscious users | US MSB across 50 states, MiCA, FCA | Merkle-tree, semi-annual | Excellent — through every market cycle | 🟢 Green |
| **[Binance](/reviews/binance)** | Active traders, broad coin selection | MiCA (selected entities), MAS application pending | Merkle-tree, on-demand | Good — some delays during 2023 outflows | 🟢 Green (with caveats) |
| **[Bitget](/reviews/bitget)** | Derivatives, copy trading | Seychelles, Lithuania (limited) | Merkle-tree | Generally good | 🟠 Orange |
| **[BingX](/reviews/bingx)** | Copy trading, mid-tier user | Australian AUSTRAC, Lithuania | Merkle-tree | Generally good | 🟠 Orange |
| **[KuCoin](/reviews/kucoin)** | Wide altcoin selection | No tier-1 licence | Merkle-tree | OK; periodic regional restrictions | 🟠 Orange |
...
| KYC | Required | None (self-custody wallet) |
| Liquidity | Deep on majors, shallow on long tail | Deep on long tail, often shallow on majors |
| Counterparty risk | Significant — exchange can fail | None — but smart contract risk instead |
| User error survivability | Better (can call support, recover password) | Worse (lose seed = lose everything) |

...
const SECTORS: { slug: string; label: string; blurb: string; icon: typeof Bot; accent: string; image?: string }[] = [
  { slug: "crypto-trading", label: "Crypto Trading", blurb: "Bots, AI and copy trading — the hands-off ways to trade, rated on evidence.", icon: Bot, accent: "#4F8BFF", image: "/crypto-trading/hero.png" },
...
const AiFinance = () => {
  ...
  const guides = ["aurum-neyro-bot-review-is-aurum-a-scam", "what-is-ai-finance-crypto", "non-custodial-ai-trading-bots-explained", "non-custodial-smart-contract-trading-explained", "how-smart-contracts-work-crypto-trading", "copy-ai-trading-explained-2026", "ai-trading-bots-and-agents-2026-honest-guide", "how-to-spot-ai-washing-crypto", "are-telegram-trading-bots-safe-a-crypto-watchdog-investigation-2026-05-09", "crypto-trading-bot-risks-safer-trading"]
